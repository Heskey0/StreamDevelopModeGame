...
public class pinkBullet2Mono : MonoBehaviour
{
    ...
    private void Start()
    {
        rotateDeg= Shoot.r.NextFloat(-30, 30);
    ...
    private void Update()
    {
        ...
        transform.position += (Vector3) math.mul(transform.rotation, new float3(1, 0, 0)) * (Time.deltaTime * speed);
        Track();
    }
